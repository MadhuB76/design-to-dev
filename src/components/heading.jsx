    ...
    <div className="relative">
      ...
      >
        ...
        <div className="hidden md:flex flex-col h-full">
          ...
          <motion.div
            className="flex flex-1 items-center justify-end w-full max-w-xl mx-auto z-20"
          ...
          <motion.div
            className="relative flex justify-between items-end w-full max-w-6xl mx-auto pb-4 md:pb-8 z-0"
            initial={{ x: 0 }}
            animate={{ x: 0 }}
          >
        ...
        <motion.div
          className="flex md:hidden flex-col h-full justify-between items-start"
        ...
        >
          ...
          <motion.div
            className="flex flex-row justify-between items-center w-full max-w-full mx-auto pb-4 md:pb-8 z-0"
